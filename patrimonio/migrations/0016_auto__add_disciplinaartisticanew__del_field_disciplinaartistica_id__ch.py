...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DisciplinaArtisticaNEW'
        db.create_table(u'patrimonio_disciplinaartisticanew', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('disciplina', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ))
        db.send_create_signal(u'patrimonio', ['DisciplinaArtisticaNEW'])

    def backwards(self, orm):
        # Deleting model 'DisciplinaArtisticaNEW'
        db.delete_table(u'patrimonio_disciplinaartisticanew')
