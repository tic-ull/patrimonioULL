...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ObraDeArte.localizacion'
        raise RuntimeError("Cannot reverse this migration. 'ObraDeArte.localizacion' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ObraDeArte.localizacion'
        db.add_column(u'patrimonio_obradearte', 'localizacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patrimonio.LocalizacionObra'], on_delete=models.PROTECT),
                      keep_default=False)
