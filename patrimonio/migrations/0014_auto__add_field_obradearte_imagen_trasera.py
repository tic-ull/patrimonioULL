...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObraDeArte.imagen_trasera'
        db.add_column(u'patrimonio_obradearte', 'imagen_trasera',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObraDeArte.imagen_trasera'
        db.delete_column(u'patrimonio_obradearte', 'imagen_trasera')
