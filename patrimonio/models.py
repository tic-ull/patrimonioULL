...
class TablaDeFichasDelInventario(models.Model):
    ...
    imagen = models.ImageField(db_column="IMAGEN", upload_to='images',
                               blank=True)
    medidas = models.CharField(db_column='MEDIDAS', max_length=100, blank=True)
    tematica_y_estilo = models.CharField(u"Temática y Estilo",
                                         db_column='TEMATICA Y ESTILO',
                                         max_length=50, blank=True)
    tecnica = models.CharField(u"Técnica", db_column='TECNICA', max_length=50,
                               blank=True)
    fecha = models.CharField(db_column='FECHA', max_length=100, blank=True)
    ubicacion = models.TextField(u"Ubicación", db_column='UBICACION',
                                 blank=True)
    estado_de_conservacion = models.CharField(u"Estado de Conservación",
                                              db_column='ESTADO DE CONSERVACION',
                                              max_length=50, blank=True)
