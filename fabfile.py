...
def create_enviroment():
    sudo('mkdir -p %s/VIRTUALENV && cd %s/VIRTUALENV && virtualenv .' % (env.path, env.path))
    sudo('rm %s/VIRTUALENV/lib/python%s/no-global-site-packages.txt' % (env.path, env.python_version))
